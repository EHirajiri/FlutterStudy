...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 8021539010831921610),
    name: 'LifeEvent',
    lastPropertyId: const obx_int.IdUid(3, 2778028881971957033),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 7309333230638620872),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 7962320914089133191),
        name: 'title',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 2778028881971957033),
        name: 'count',
        type: 6,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    entities: _entities,
    lastEntityId: const obx_int.IdUid(1, 8021539010831921610),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    LifeEvent: obx_int.EntityDefinition<LifeEvent>(
      model: _entities[0],
...
class LifeEvent_ {
  /// See [LifeEvent.id].
  static final id = obx.QueryIntegerProperty<LifeEvent>(
    _entities[0].properties[0],
  );

  /// See [LifeEvent.title].
  static final title = obx.QueryStringProperty<LifeEvent>(
    _entities[0].properties[1],
  );

  /// See [LifeEvent.count].
  static final count = obx.QueryIntegerProperty<LifeEvent>(
